...
(function () {
  ...
  const NEW = {
    ka: {
      ...
      "pricing.weekly": "ერთჯერადი საცდელი პერიოდი",
      ...
      "pricing.weeklyDesc": "გამოსცადეთ კლიენტი სრულად, არანაირი გადახდის გარეშე, სანამ ტარიფს აირჩევთ.",
    ...
    en: {
      ...
      "pricing.weekly": "One-Time Free Trial",
      ...
      "pricing.weeklyDesc": "Try the full client with no payment required before you pick a plan.",
  ...
  const PRICING_BTNS = [
    ["#pricing .pricing-card:nth-child(1) .buy-btn", "pricing.tryFree"],
