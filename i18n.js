...
(function () {
  ...
  const NEW = {
    ka: {
      ...
      "dash.pvpDesc": "საუკეთესოა PvP ბრძოლებისთვის, ოპტიმიზირებული FPS-ითა და ქილებიგერით",
      "dash.basefindVersion": "Pulse Base Find (Base-ების საპოვნელად)",
      "dash.basefindDesc": "ბაზების საპოვნელად და სათვალთვალოდ, Matrix / GrimAC შემოვლებით",
    ...
    en: {
      ...
      "dash.pvpDesc": "Best for PvP combats, optimized with enhanced FPS and kill trigger",
      "dash.basefindVersion": "Pulse Base Find (for Base Finding)",
      "dash.basefindDesc": "Designed for base finding and tracking, bypassing Matrix and GrimAC",
