...
(function () {
  ...
  const NEW = {
    ka: {
      ...
      "pricing.free": "უფასო",
      "pricing.per3": "/ 3 დღე",
      "pricing.trialDesc": "გამოსცადეთ კლიენტი სრულად, გადახდის გარეშე, სანამ ტარიფს არ აირჩევთ.",
      ...
      "modules.title": "ყველა 87 მოდული",
      "modules.subtitle": "მოდულების სრული სია და მათი მიმდინარე დეტექციის სტატუსი.",
      "modules.stats.total": "სულ მოდულები",
      "modules.stats.undetected": "Undetected",
      "modules.stats.useAtRisk": "Use at Risk",
      "modules.stats.detected": "Detected",
      "modules.searchPlaceholder": "მოძებნე მოდული...",
      "modules.category.all": "ყველა მოდული",
      "modules.category.combat": "Combat",
      "modules.category.crystal": "Crystal",
      "modules.category.player": "Player",
      "modules.category.movement": "Movement",
      "modules.category.render": "Render",
      "modules.category.donut": "Donut",
      "modules.category.misc": "Misc",
      "modules.category.client": "Client",
      "modules.status.undetected": "Undetected",
      "modules.status.useAtRisk": "Use at Risk",
      "modules.status.detected": "Detected"
    },
    en: {
      ...
      "nav.modules": "Modules",
      "modules.title": "All 87 Modules",
      "modules.subtitle": "Full list of modules and their current detection status.",
      "modules.stats.total": "Total Modules",
      "modules.stats.undetected": "Undetected",
      "modules.stats.useAtRisk": "Use at Risk",
      "modules.stats.detected": "Detected",
      "modules.searchPlaceholder": "Search modules...",
      "modules.category.all": "All Modules",
      "modules.category.combat": "Combat",
      "modules.category.crystal": "Crystal",
      "modules.category.player": "Player",
      "modules.category.movement": "Movement",
