...
(function () {
  ...
  const NEW = {
    ka: {
      ...
      "dash.referralRedeemPlaceholder": "მაგ: PULSE-USERNAME",
      "dash.referralRedeemBtn": "გააქტიურება",
      "msg.refCodeInvalid": "არასწორი კოდის ფორმატი. კოდი უნდა იწყებოდეს PULSE-ით.",
    ...
    en: {
      ...
      "dash.referralRedeemPlaceholder": "e.g. PULSE-USERNAME",
      ...
      "msg.refCodeInvalid": "Invalid code format. The code must start with PULSE-.",
