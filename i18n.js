const TRANSLATIONS = {
    ka: {
        ...
        "hero.desc": "მოიპოვეთ უპირატესობა თამაშში სრულად კონფიგურირებადი Combat მოდიფიკაციებით, პრემიუმ ვიზუალური ESP-ებით და ანტი-ჩითის ძლიერი შემოვლის სისტემით. შექმნილია მაღალი დონის მოთამაშეებისთვის.",
        ...
        "features.subtitle": "შექმნილია ნულიდან მაქსიმალური საბრძოლო ეფექტურობისთვის, სუფთა ვიზუალისთვის და სტაბილური შემოვლებისთვის.",
        "features.f1.title": "Combat მოდიფიკაციები",
        "features.f1.desc": "სრულად კონფიგურირებადი AutoClicker, Reach, Velocity/Knockback შემცირება და AimAssist, რომელიც მუშაობს სრულიად ლეგიტიმურად.",
        "features.f2.title": "ვიზუალური ფუნქციები",
        "features.f2.desc": "სუფთა Player Chams, Chest ESP, დეტალური HUD ოვერლეი და Tracers, რომელიც არ ჩანს ეკრანის ჩაწერის პროგრამებში.",
        "features.f3.title": "გაფართოებული შემოვლები",
        "features.f3.desc": "ფარული პაკეტების მანიპულაცია Matrix, GrimAC, Vulcan და სხვა თანამედროვე ანტი-ჩითების გვერდის ასავლელად.",
        "features.f4.title": "Discord ინტეგრაცია",
        "features.f4.desc": "გაააქტიურეთ გასაღებები, ნახეთ დეტალები და მართეთ როლები მარტივად ჩვენი ავტომატიზებული Discord ბოტის მეშვეობით.",
        "pricing.title": "მარტივი და გამჭვირვალე ფასები",
        "pricing.subtitle": "აირჩიეთ ტარიფი, რომელიც საუკეთესოდ შეესაბამება თქვენს სათამაშო გრაფიკს.",
        "pricing.weekly": "ყოველკვირეული ტარიფი",
        ...
        "pricing.weeklyDesc": "იდეალურია კლიენტის შესაძლებლობების გასატესტად და ყოველკვირეული ტურნირებისთვის.",
        "pricing.monthlyDesc": "სტანდარტული არჩევანი აქტიური და კონკურენტუნარიანი Minecraft მოთამაშეებისთვის.",
        "pricing.lifetimeDesc": "გადაიხადე ერთხელ, ითამაშე სამუდამოდ. მიიღე პრიორიტეტული წვდომა ყველა სამომავლო განახლებაზე.",
        ...
        "purchaseModal.title": "შეძენისთვის გვითხარეთ Discord-ზე",
        "purchaseModal.desc": "ამ ტარიფის შესაძენად, გადადით ჩვენს Discord სერვერზე და გახსენით ticket მხარდაჭერის განყოფილებაში. ჩვენი გუნდი დაგეხმარებათ გადახდასა და გასაღების გენერაციაში სულ რამდენიმე წუთში.",
        ...
        "purchaseModal.step3": "დაელოდეთ მხარდაჭერის გუნდს და მიეთვალეთ მითხვევებს",
        ...
        "dash.opsecDesc": "ამ მოდის ჩაწერა კატეგორიულად აუცილებელია უსაფრთხოებისთვის (OpSec). წინააღმდეგ შემთხვევაში ჩვენ ვიხსნით სრულ პასუხისმგებლობას თქვენს ანგარიშებზე!",
        ...
        "dash.launchersNote": "სხვა Fabric-თავსებადი ლაუნჩერებიც შეიძლება მუშაობდეს - დანარჩენი თქვენზეა.",
        ...
        "dash.bindDesc": "თუ გაქვთ Discord ბოტიდან გენერირებული გასაღები, რომელიც ჯერ არ არის დაკავშირებული საიტთან, ჩაწერეთ ის ქვემოთ თქვენს Discord პროფილზე მისაბმელად.",
        ...
        "faq.a1": "ტარიფის შეძენის შემდეგ, თქვენ შეგიძლიათ გასაღები პირდაპირ ჩვენს Discord სერვერზე ბოტის ბრძანებებით შექმნათ, ან დააკავშირეთ ის აქ, დეშბორდზე.",
        "faq.q2": "სად უნდა ჩავწერო გასაღები სათამაშოდ?",
        "faq.a2": "როდესაც Minecraft-ს მოდით ჩართავთ, გამოჩნდება სპეციალური მუქი ფანჯარა, რომელიც მოგთხოვთ გასაღებს. ჩაწერეთ ის იქ და დააჭირეთ Activate! გასაღები ავტომატურად დაემატება და შეინახება.",
        "faq.q3": "შემიძლია ჩემი გასაღები რამდენიმე კომპიუტერზე გამოვიყენო?",
        "faq.a3": "გასაღების გაზიარების თავიდან ასაცილებლად, ყოველი გასაღები ებმება პირველივე კომპიუტერის HWID კოდს, რომელზეც გააქტიურდება. HWID-ის განულება შეგიძლიათ ჩვენს Discord სერვერზე მხარდაჭერის ჯგუფთან დაკავშირებით.",
