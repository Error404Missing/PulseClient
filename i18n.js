...
(function () {
  ...
  const NEW = {
    ka: {
      ...
      "purchaseModal.title": "შეიძინე PulseClient ლიცენზია",
      "purchaseModal.desc": "შეიძინეთ ლიცენზია ონლაინ კრიპტოვალუტით (Litecoin) ან დაგვიკავშირდით Discord-ზე.",
      "purchaseModal.cta": "ონლაინ შეძენა (Crypto)",
      "purchaseModal.discord": "Discord-ით შეძენა",
    ...
    en: {
      ...
      "purchaseModal.title": "Purchase PulseClient License",
      "purchaseModal.desc": "Purchase your license instantly online using Crypto (Litecoin) or contact us on Discord.",
      "purchaseModal.cta": "Purchase Online (Crypto)",
      "purchaseModal.discord": "Purchase via Discord",
