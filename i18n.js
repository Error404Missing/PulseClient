...
(function () {
  ...
  const NEW = {
    ka: {
      ...
      "ai.subtitle": "24/7 ასისტენტი მხარდაჭერისთვის",
      "ai.welcomeMsg": "გამარჯობა! მე ვარ <strong>Pulse AI</strong> . როგორ დაგეხმარო დღეს? (შეგიძლია დამისვა კითხვები ინსტალაციაზე, ღილაკებზე, შეძენაზე ან პრობლემებზე).",
      "ai.inputPlaceholder": "დასვი კითხვა...",
      ...
      "dash.faq": "კითხვები",
      "dash.configs": "კონფიგები (Presets)",
      ...
      "dash.clientTitle": "PulseClient",
      "dash.chooseVersion": "აირჩიეთ სასურველი ვერსია",
      "dash.pvpVersion": "Pulse PvP Client (PvP-სთვის)",
      "dash.pvpDesc": "საუკეთესოა PvP ბრძოლებისთვის, ოპტიმიზირებული FPS-ითა და ქილებიგერით (მენიუ იხსნება F12 ღილაკით)",
      "dash.basefindVersion": "Pulse Base Find (Base-ების საპოვნელად)",
      "dash.basefindDesc": "ბაზების საპოვნელად და სათვალთვალოდ, Matrix / GrimAC შემოვლებით (მენიუ იხსნება Right Shift ღილაკით)",
      ...
      "dash.download": "ჩამოტვირთვა",
            "dash.cleanerTitle": "Pulse OpSec Trace Cleaner (.bat)",
      "dash.cleanerDesc": "ჩაიწერეთ და გაუშვით შემოწმებამდე (Check / Screenshare). სკრიპტი 1 წამში სრულად ასუფთავებს Minecraft-ის ლოგებს, Crash Report-ებს, Windows Temp და Prefetch კვალს.",
      "dash.cleanerCopyBtn": "კოდის კოპირება",
      "dash.cleanerDlBtn": "ჩამოტვირთვა (.bat)",
            "dash.cleanerTitle": "Pulse OpSec Trace Cleaner (.bat)",
      "dash.cleanerDesc": "Download and run before server staff checks or screenshares. Cleans Minecraft logs, crash reports, temp files, and prefetch traces in 1 second.",
      "dash.cleanerCopyBtn": "Copy Script",
      "dash.cleanerDlBtn": "Download (.bat)",
      ...
      "dash.referralDesc": "გაუზიარე შენი რეფერალური ლინკი ან კოდი მეგობარს. როდესაც ის დარეგისტრირდება და გაააქტიურებს თავის პირველ გასაღებს (ან აიღებს საცდელ ვერსიას), შენს აქტიურ ლიცენზიას ავტომატურად დაემატება 3 დღე!",
      "dash.referralLinkLabel": "რეფერალური ლინკი",
      "dash.referralLinkCopyBtn": "ლინკის კოპირება",
      "dash.referralCodeLabel": "რეფერალური კოდი",
      "dash.referralCodeCopyBtn": "კოდის კოპირება",
      "dash.referralRedeemTitle": "რეფერალური კოდის გამოყენება",
      "dash.referralRedeemDesc": "თუ მეგობარმა გაგიზიარა რეფერალური კოდი, ჩაწერე აქ — შენს პირველ გასაღების გააქტიურებაზე ან საცდელის აღებაზე მას დაემატება 3 დღე.",
      "dash.referralRedeemPlaceholder": "მაგ: RFGS313",
      "dash.referralRedeemBtn": "გააქტიურება",
      "msg.refCodeInvalid": "არასწორი კოდის ფორმატი. კოდი უნდა შედგებოდეს 7 სიმბოლოსგან.",
      "msg.refCodeSelf": "თქვენი საკუთარი კოდის გამოყენება არ შეგიძლიათ.",
      "msg.refCodeNotFound": "მოცემული რეფერალური კოდი ვერ მოიძებნა.",
      "msg.refCodeAlready": "თქვენ უკვე გაქვთ შენახული აქტიური რეფერალი.",
      "msg.refCodeAlreadyUsed": "თქვენ უკვე გამოიყენეთ რეფერალური კოდი.",
      "msg.refCodeSuccess": "რეფერალური კოდი წარმატებით გააქტიურდა!",
      "msg.refCodeFail": "შეცდომა რეფერალური კოდის გააქტიურებისას: ",
      "msg.refCodeBtn": "გააქტიურება",
      "dash.promocodes": "პრომო კოდები",
      "promo.badge": "🎁 ბონუსები & პრომო სისტემა",
      "promo.title": "პრომო კოდის გააქტიურება",
      "promo.desc": "შეიყვანეთ მედია კრეატორის, სტრიმერის ან სარეკლამო კამპანიის პრომო კოდი უფასო დღეების და ბონუსების მისაღებად.",
      "promo.codePh": "მაგ: PULSE2026",
      "promo.redeemBtn": "გააქტიურება",
      "msg.promoPasted": "კოდი ჩასმულია ბუფერიდან!",
      ...
      "telemetry.mcUser": "მომხმარებელი / MC",
      "telemetry.key": "გასაღები",
      "telemetry.server": "სერვერი",
      "telemetry.launcher": "ლაუნჩერი",
      "telemetry.specs": "აპარატურა (Specs)",
      "telemetry.antiAlt": "Anti-Alt / Trust",
      ...
      "telemetry.actions": "მართვა",
      "dash.totalPlaytimeLabel": "სულ ნათამაშებია",
      "dash.topServerLabel": "საყვარელი სერვერი",
    ...
    en: {
      ...
      "dash.clientTitle": "PulseClient",
      "dash.chooseVersion": "Choose your version",
      "dash.pvpVersion": "Pulse PvP Client (for PvP)",
      "dash.pvpDesc": "Best for PvP combats, optimized with enhanced FPS and kill trigger (Menu opens with F12)",
      "dash.basefindVersion": "Pulse Base Find (for Base Finding)",
      "dash.basefindDesc": "Designed for base finding and tracking, bypassing Matrix and GrimAC (Menu opens with Right Shift)",
      ...
      "dash.referralDesc": "Share your referral link or code with a friend. When they register and activate their first key (or claim a trial), your active license will automatically get 3 days added!",
      "dash.referralLinkLabel": "Referral Link",
      "dash.referralLinkCopyBtn": "Copy Link",
      "dash.referralCodeLabel": "Referral Code",
      "dash.referralCodeCopyBtn": "Copy Code",
      "dash.referralRedeemTitle": "Use Referral Code",
      "dash.referralRedeemDesc": "If a friend shared a referral code with you, enter it here — once you activate your first key or claim a trial, they will receive 3 bonus days.",
      "dash.referralRedeemPlaceholder": "e.g. RFGS313",
      "dash.referralRedeemBtn": "Activate",
      "dash.promocodes": "Promo Codes",
      "promo.badge": "🎁 Bonuses & Promo System",
      "promo.title": "Redeem Promo Code",
      "promo.desc": "Enter a media creator, streamer or campaign promo code to receive bonus client license days.",
      "promo.codePh": "e.g. PULSE2026",
      "promo.redeemBtn": "Redeem Code",
      "msg.promoPasted": "Code pasted from clipboard!",
      ...
      "msg.refCodeInvalid": "Invalid code format. The code must be exactly 7 alphanumeric characters.",
      "msg.refCodeSelf": "You cannot use your own referral code.",
      "msg.refCodeNotFound": "Referral code not found.",
      "msg.refCodeAlready": "You already have a pending referral.",
      "msg.refCodeAlreadyUsed": "You have already used a referral code.",
      "msg.refCodeSuccess": "Referral code successfully activated!",
      "msg.refCodeFail": "Failed to redeem referral code: ",
      "msg.refCodeBtn": "Activate",
      ...
      "telemetry.mcUser": "User / MC",
      "telemetry.key": "Key",
      "telemetry.server": "Server",
      "telemetry.launcher": "Launcher",
      "telemetry.specs": "Hardware (Specs)",
      "telemetry.antiAlt": "Anti-Alt / Trust",
      ...
      "telemetry.actions": "Control",
      "dash.totalPlaytimeLabel": "Total Playtime",
      "dash.topServerLabel": "Top Server",
  ...
  const SELECTOR_BINDINGS = [
    ...
    ["#tab-content-redeem .bind-card h3", "dash.bindTitle"],
    ["#tab-content-redeem .bind-card .desc", "dash.bindDesc"],
    ["#bind-submit-btn", "dash.bindBtn"],
    ["#tab-content-faq .section-title", "dash.faqTitle"],
    ["#faq .section-header h2", "faq.title"],
    [".admin-create-card > h3:not([data-i18n])", "admin.genTitle"],
    ...
    ["#admin-subpanel-licenses .admin-header h3", "admin.manageTitle"],
    ["#admin-subpanel-sessions .admin-header h3", "admin.telemetryTitle"],
